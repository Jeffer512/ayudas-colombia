...
export default function RegisterPage() {
  ...
  const mutation = useMutation({
    mutationFn: () => api.register({ name, email, password, orgId }),
  ...
  return (
    <div className="mx-auto max-w-md">
      <h1 className="text-2xl font-bold tracking-tight">
        Registro del personal de la organización
      </h1>
      <p className="mt-1 text-sm text-slate-600">
        Regístrate para gestionar una organización de la Red de ayudas y
        publicar pedidos a nombre de ella. Después de registrarte tendrás que
        verificar tu correo.
      </p>
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-4">
        ...
        <button
          type="submit"
          disabled={mutation.isPending || !orgsQuery.data}
